...
import com.apps.emdad.databinding.ChatImageLeftRowBinding;
import com.apps.emdad.databinding.ChatImageRightRowBinding;
import com.apps.emdad.databinding.ChatLocationLeftBinding;
import com.apps.emdad.databinding.ChatLocationRightBinding;
import com.apps.emdad.databinding.ChatMessageAudioLeftRowBinding;
import com.apps.emdad.databinding.ChatMessageAudioRightRowBinding;
import com.apps.emdad.databinding.ChatMsgLeftBinding;
import com.apps.emdad.databinding.ChatMsgRightBinding;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof HolderMsgLeft) {
            ...
            holderImageLeft.itemView.setOnClickListener(v -> {
                ...
                String url = Tags.IMAGE_URL+messageModel.getImage();
